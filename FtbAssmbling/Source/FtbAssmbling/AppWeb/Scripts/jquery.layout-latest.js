...
,	panes: { // default options for 'all panes' - will be overridden by 'per-pane settings'
	...
	//	PANE-SPECIFIC TIPS & MESSAGES 顯示訊息字樣
	,	tips: {
			Open:				"打開"		// eg: "Open Pane"
		,	Close:				"關閉"
		,	Resize:				"調整尺寸"
		,	Slide:				"邊欄打開"
		,	Pin:				"標示"
		,	Unpin:				"不標示"
		,	noRoomToOpen:		"無足夠空間顯示此區塊"	// alert if user tries to open a pane that cannot
		,	minSizeWarning:		"區塊達到最小尺寸"	// displays in browser statusbar
		,	maxSizeWarning:		"區塊達到最快尺寸"	// ditto
		}
	//	HOT-KEYS & MISC
