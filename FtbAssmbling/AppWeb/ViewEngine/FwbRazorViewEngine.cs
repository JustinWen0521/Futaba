...
namespace ftd.mvc.ViewEngine
{
    public class FwbRazorViewEngine : RazorViewEngine
    {
        public FwbRazorViewEngine() : base()
        {
        ...
        protected override bool FileExists(ControllerContext controllerContext, string virtualPath)
        {
            ...
            var nameSpace = controllerContext.Controller.GetType().Namespace;
            var viewPath = virtualPath.Replace("%1", nameSpace);
            var result = base.FileExists(controllerContext, viewPath);
            return result;
        }
    }
}